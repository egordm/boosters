...
impl<L: LeafValue> TreeBuilder<L> {
    ...
    pub fn build(self) -> SoATreeStorage<L> {
        ...
        SoATreeStorage::with_categories(
            self.split_indices,
...
mod tests {
    ...
    fn build_categorical_tree() -> SoATreeStorage<ScalarLeaf> {
        let mut builder = TreeBuilder::new();
    ...
    fn build_multi_word_categorical_tree() -> SoATreeStorage<ScalarLeaf> {
        let mut builder = TreeBuilder::new();
    ...
    fn build_mixed_tree() -> SoATreeStorage<ScalarLeaf> {
        let mut builder = TreeBuilder::new();
