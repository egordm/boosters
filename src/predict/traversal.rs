...
use crate::trees::{
    float_to_category, Depth6, LeafValue, ScalarLeaf, SoATreeStorage, UnrollDepth,
    UnrolledTreeLayout,
};
...
#[inline]
pub fn traverse_from_node(tree: &SoATreeView<'_, ScalarLeaf>, start_node: u32, features: &[f32]) -> u32 {
...
impl TreeTraversal<ScalarLeaf> for StandardTraversal {
    ...
    #[inline]
    fn build_tree_state(_tree: &SoATreeStorage<ScalarLeaf>) -> Self::TreeState {
...
pub type UnrolledTraversal4 = UnrolledTraversal<crate::trees::Depth4>;

/// Unrolled traversal with depth 6 (63 nodes, 64 exits) - default.
pub type UnrolledTraversal6 = UnrolledTraversal<crate::trees::Depth6>;

/// Unrolled traversal with depth 8 (255 nodes, 256 exits).
pub type UnrolledTraversal8 = UnrolledTraversal<crate::trees::Depth8>;
