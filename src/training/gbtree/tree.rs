...
//!
//! See [`policy`](super::policy) module for growth policy implementations.
//!
//! # Example
//!
//! ```ignore
...
mod tests {
    use super::*;
    use crate::training::gbtree::policy::{
        DepthWisePolicy, DepthWiseState, GrowthStrategy, LeafCandidate, LeafWisePolicy,
    };
