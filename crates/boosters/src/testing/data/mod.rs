...
#[deprecated(since = "0.2.0", note = "Use random_features_array instead")]
...
#[deprecated(since = "0.2.0", note = "Use synthetic_regression instead")]
#[allow(deprecated)]
...
#[deprecated(since = "0.2.0", note = "Use synthetic_binary instead")]
#[allow(deprecated)]
...
#[deprecated(since = "0.2.0", note = "Use synthetic_multiclass instead")]
