...
Validate the unified `Predictor<T>` design and measure the impact of different
traversal strategies. Hypothesis: UnrolledTraversal should be faster than
StandardTraversal for batch prediction due to better cache utilization.
