...
| Dataset | boosters | XGBoost | LightGBM |
|---------|-----------|---------|----------|
| multiclass_small | **0.627704 ± 0.012191** | 0.768526 ± 0.014709 | 0.667382 ± 0.017385 |
| multiclass_medium | **0.765417 ± 0.010978** | 0.953940 ± 0.012128 | 0.825901 ± 0.010887 |
| covertype | **0.420593 ± 0.006009** | 0.471790 ± 0.003905 | 0.429031 ± 0.005213 |

### Accuracy (higher is better)

| Dataset | boosters | XGBoost | LightGBM |
|---------|-----------|---------|----------|
| multiclass_small | **0.7585 ± 0.0056** | 0.7338 ± 0.0060 | 0.7510 ± 0.0095 |
| multiclass_medium | **0.7463 ± 0.0066** | 0.7042 ± 0.0080 | 0.7348 ± 0.0063 |
| covertype | **0.8250 ± 0.0036** | 0.8008 ± 0.0023 | 0.8204 ± 0.0040 |
