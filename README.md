...
├── objective.rs        # Output transformations (sigmoid, softmax)
├── compat/             # Format compatibility
│   └── xgboost/        # XGBoost JSON loader
├── data/               # Data matrix abstractions
├── forest/             # Forest (ensemble) structures
├── predict/            # Prediction visitor pattern
└── trees/              # Tree storage and traversal
